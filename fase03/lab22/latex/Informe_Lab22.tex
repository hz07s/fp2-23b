...
\end{itemize}
\lstinputlisting[language=Java, firstline=199, lastline=227,firstnumber=199,numbers=left]{src/VideoJuego.java}
\begin{itemize}
...
\end{itemize}
\lstinputlisting[language=Java, firstline=233, lastline=245,firstnumber=233,numbers=left]{src/VideoJuego.java}
\newpage
\begin{itemize}
...
\end{itemize}
\lstinputlisting[language=Java, firstline=247, lastline=261,firstnumber=247,numbers=left]{src/VideoJuego.java}
\begin{figure}[H]
    \centering
...
\end{itemize}
\lstinputlisting[language=Java, firstline=3, lastline=5,firstnumber=3,numbers=left]{src/Ejercito.java}
...
\end{itemize}
\lstinputlisting[language=Java, firstline=7, lastline=24,firstnumber=7,numbers=left]{src/Ejercito.java}
\begin{itemize}
    \item \texttt{\textcolor{blue}{Getters y Setters}}: 
\end{itemize}
\lstinputlisting[language=Java, firstline=30, lastline=52,firstnumber=30,numbers=left]{src/Ejercito.java}
\begin{itemize}
...
\end{itemize}
\lstinputlisting[language=Java, firstline=54, lastline=110,firstnumber=54,numbers=left]{src/Ejercito.java}
\newpage
\begin{itemize}
...
\end{itemize}
\lstinputlisting[language=Java, firstline=112, lastline=138,firstnumber=112,numbers=left]{src/Ejercito.java}
